-- ============================================================
-- MIGRATION 002: Normalize Schema with Foreign Keys
-- ============================================================
-- Date: 2025-11-18
...
UPDATE nodes SET
    ...
    region = 'Araucanía',
    voltage_kv = 110
WHERE code = 'PIDPID___110';

RAISE NOTICE 'Created nodes table with % entries', (SELECT COUNT(*) FROM nodes);
...
RAISE NOTICE 'Added node_id foreign key to cmg_online';
...
RAISE NOTICE 'Added node_id foreign key to cmg_programado';

-- ============================================================
-- STEP 4: Add Constraint to ml_predictions (Data Integrity)
-- ============================================================

-- Ensure horizon matches time difference between forecast and target
ALTER TABLE ml_predictions DROP CONSTRAINT IF EXISTS check_horizon_matches_time;
ALTER TABLE ml_predictions ADD CONSTRAINT check_horizon_matches_time
    CHECK (
        ABS(EXTRACT(EPOCH FROM (target_datetime - forecast_datetime))/3600 - horizon) < 0.1
    );

RAISE NOTICE 'Added horizon validation constraint to ml_predictions';

-- ============================================================
-- STEP 5: Create Convenience Views (Santiago Timezone)
-- ============================================================
...
-- ============================================================
-- STEP 7: Update Triggers for new tables
-- ============================================================
...
-- ============================================================
-- STEP 8: Grant RLS Policies for new tables/views
-- ============================================================
